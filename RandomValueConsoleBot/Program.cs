...
namespace RandomValueConsoleBot
{
    ...
    class Program
    {
        private static string[] lines = System.IO.File.ReadAllLines(Directory.GetCurrentDirectory()+@"\"+"RandomValuebotToken.txt");//you should have this file and first line should be Token
